        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center space-x-2">
            ...
            <p className="text-white/30 text-[10px] font-bold uppercase tracking-[0.2em]">
              {habits.length}/{habitLimit} Unidades Ativas
            </p>
          </div>
        </div>
        <motion.button 
          ...
          disabled={habits.length >= habitLimit}
          ...
          >
            ...
            >
              <div className="flex justify-between items-center">
                <div className="space-y-1">
                  <h3 className="text-2xl font-display font-bold uppercase tracking-tight">Novo Protocolo</h3>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex items-center space-x-1.5 text-[10px] text-white/30 font-bold uppercase tracking-widest">
                    <ShieldCheck size={14} />
        ...
        {habits.length === 0 && (
          <div className="py-24 text-center space-y-6">
            ...
            <div className="space-y-2">
              <p className="text-white/20 text-xs font-bold uppercase tracking-[0.3em]">Nenhum Protocolo Ativo</p>
              <p className="text-white/10 text-[10px] uppercase tracking-widest">Inicialize sua primeira diretriz de performance</p>
            </div>
          </div>
        )}
      </div>
