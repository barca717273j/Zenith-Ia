      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <section className="space-y-4">
          <div className="flex items-center space-x-2 px-1">
            ...
            <h3 className="text-[10px] font-bold uppercase tracking-widest text-white/60">{t.dashboard.dailySummary}</h3>
          </div>
          <div className="glass-card p-6 space-y-6 border-white/5 bg-white/[0.01]">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <p className="text-[8px] text-white/20 uppercase font-bold tracking-widest">Missões</p>
                <p className="text-xl font-display font-bold">4/5</p>
              </div>
              <div className="space-y-1">
                <p className="text-[8px] text-white/20 uppercase font-bold tracking-widest">Hábitos</p>
            ...
            <div className="space-y-2">
              ...
              <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
                <div className="h-full bg-zenith-scarlet w-[85%] shadow-[0_0_10px_rgba(255,36,0,0.4)]" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <div className="flex items-center space-x-2 px-1">
            ...
            <h3 className="text-[10px] font-bold uppercase tracking-widest text-white/60">{t.dashboard.weeklyProgress}</h3>
          </div>
          <div className="glass-card p-6 space-y-6 border-white/5 bg-white/[0.01]">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-[8px] text-white/20 uppercase font-bold tracking-widest">XP Ganho</p>
            ...
            <div className="flex items-center space-x-2">
              {[60, 40, 80, 100, 70, 90, 50].map((h, i) => (
                <div key={i} className="flex-1 flex flex-col items-center space-y-2">
                  <div className="w-full bg-white/5 rounded-t-sm relative group" style={{ height: `${h}%` }}>
                    <div className="absolute inset-0 bg-zenith-scarlet opacity-20 group-hover:opacity-40 transition-opacity" />
                  </div>
                  <span className="text-[6px] text-white/20 font-bold uppercase">{['S', 'M', 'T', 'W', 'T', 'F', 'S'][i]}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center space-x-2 px-1">
            <Wallet size={14} className="text-zenith-scarlet" />
            <h3 className="text-[10px] font-bold uppercase tracking-widest text-white/60">{t.dashboard.financialSummary}</h3>
          </div>
          <div className="glass-card p-6 space-y-6 border-white/5 bg-white/[0.01]">
            <div className="space-y-4">
              <div className="flex justify-between items-end">
                <div className="space-y-1">
                  <p className="text-[8px] text-white/20 uppercase font-bold tracking-widest">{t.dashboard.balance}</p>
                  <p className="text-2xl font-display font-bold">R$ 4.250,00</p>
                </div>
                <div className="text-right space-y-1">
                  <p className="text-[8px] text-white/20 uppercase font-bold tracking-widest">{t.dashboard.expenses}</p>
                  <p className="text-sm font-bold text-zenith-scarlet">- R$ 1.120,00</p>
                </div>
              </div>
              <div className="h-1 bg-white/5 rounded-full overflow-hidden flex">
                <div className="h-full bg-emerald-500 w-[70%]" />
                <div className="h-full bg-zenith-scarlet w-[30%]" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <div className="flex items-center space-x-2 px-1">
            ...
            <h3 className="text-[10px] font-bold uppercase tracking-widest text-white/60">{t.dashboard.mentalProgress}</h3>
          </div>
          <div className="glass-card p-6 space-y-6 border-white/5 bg-white/[0.01]">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <p className="text-[8px] text-white/20 uppercase font-bold tracking-widest">{t.dashboard.focusTime}</p>
                <p className="text-xl font-display font-bold">12h 45m</p>
              </div>
              <div className="space-y-1">
                <p className="text-[8px] text-white/20 uppercase font-bold tracking-widest">{t.dashboard.journalEntries}</p>
                <p className="text-xl font-display font-bold">18</p>
              </div>
            </div>
            <div className="flex items-center space-x-2 text-[8px] font-bold uppercase tracking-widest text-emerald-400 bg-emerald-400/10 px-3 py-2 rounded-lg border border-emerald-400/20">
              <Sparkles size={10} />
              <span>Clareza Mental: Ótima</span>
            </div>
          </div>
        </section>
          ...
          <div className="glass-card p-4 space-y-3">
            ...
            <div className="space-y-1">
              ...
              <div className="h-1 bg-white/5 rounded-full overflow-hidden">
                <div className="h-full bg-zenith-scarlet w-[94%] shadow-[0_0_8px_rgba(255,36,0,0.4)]" />
              </div>
            </div>
          </div>
          <div className="glass-card p-4 space-y-3">
